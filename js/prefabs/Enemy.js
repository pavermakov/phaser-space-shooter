...
SpaceHipster.Enemy.prototype.damage = function(amount) {
  ...
  if(this.health <= 0) {
    ...
    emitter.minParticleSpeed.setTo(this.game.rnd.integerInRange(-200, -50),this.game.rnd.integerInRange(-200, -50));
    emitter.maxParticleSpeed.setTo(this.game.rnd.integerInRange(50, 200),this.game.rnd.integerInRange(50, 200));
    emitter.gravity = 0;
...
SpaceHipster.Enemy.prototype.shoot = function() {
  ...
  if(!bullet) {
    bullet = new SpaceHipster.EnemyBullet(this.game, this.x, this.bottom, 'bullet');
